...
def test_enrich_falls_back_to_canonical_summary_when_run_scoped_missing(tmp_path):
    canonical = tmp_path / "summary.json"
    ...
    assert document["targets"][0]["verdict"] == "READY_FOR_HUMAN_REVIEW"
    assert document["targets"][0]["score_overall"] == 100.0
